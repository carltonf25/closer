    ...
    Tables: {
      contractors: {
        Row: {
          ...
          exclusive_only: boolean | null
          id: string
          license_number: string | null
          license_verified: boolean
          max_lead_budget: number | null
          ...
          notify_lead_updates: boolean | null
          ...
          preferred_urgencies: string[] | null
...
export type LeadDelivery = Database['public']['Tables']['lead_deliveries']['Row'];
